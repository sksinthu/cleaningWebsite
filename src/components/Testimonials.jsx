...
const Testimonials = () => {
  ...
  const reviews = [
    {
      name: "Sabrina M.",
      role: t("Wohnungsabgabe", "Move-out Cleaning"),
    ...
    {
      name: "Elena K.",
      role: t("Frühjahrsputz", "Spring Cleaning"),
    ...
    {
      name: "Markus R.",
      role: t("Umzugsreinigung", "Relocation Cleaning"),
    ...
    {
      name: "Julia S.",
      role: t("Abo-Reinigung", "Subscription Cleaning"),
