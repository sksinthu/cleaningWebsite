                   ...
                   <div className="text-left">
                      ...
                      <div className="flex flex-wrap gap-4 mb-8">
                        <a 
                          ...
                          className="inline-flex items-center gap-3 px-6 py-3 bg-primary text-white rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-secondary transition-all shadow-lg group"
                        >
